...
class UpdateChecker {
  ...
  static const _repository = 'abdedarghal111/SUS-NFC-tag-editor';
  ...
  /// Dice si hay una versión más nueva publicada.
  ///
  /// Entrada: [forceRefresh] ignora la caché. Salida: el estado de la
  /// comprobación, con [UpdateCheckFailed] cuando no se pudo resolver.
...
class _LatestRelease {
  /// Tag de la release en GitHub, con la `v` por delante.
  final String tagName;

  /// Página de la release, con las descargas de cada plataforma.
  final String releaseUrl;

  /// Momento en el que se consultó, para saber cuándo caduca la caché.
