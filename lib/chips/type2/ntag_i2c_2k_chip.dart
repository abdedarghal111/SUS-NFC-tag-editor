// NTAG I2C plus 2K: 1912 bytes de usuario y acceso por sectores.
...
/// Chip NTAG I2C plus de 2 KB (NT3H2211) de NXP.
///
/// El sector 0 tiene el mismo mapa que la versión de 1 KB; el sector 1 es
/// 1 KB más de contenido, al que se llega con SECTOR_SELECT.
class NtagI2c2kChip extends Type2Chip
    implements
        Readable,
        Writable,
        Erasable,
  ...
  static const int storage = 0x15;

  /// Cambia el sector de memoria que se direcciona.
  static const int sectorSelect = 0xC2;

  /// Sector cuyas 256 páginas son todas contenido.
  static const int extraSector = 1;

  @override
  String get name => 'NTAG I2C plus 2K';
  ...
  /// Bytes de contenido: 888 en el sector 0 y 1024 en el sector 1.
  int get userBytes => 1912;
